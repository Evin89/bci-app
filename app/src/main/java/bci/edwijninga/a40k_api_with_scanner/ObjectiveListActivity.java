...
public class ObjectiveListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ObjectiveListActivity.getScenarios().execute();
    ...
    class getScenarios extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(ObjectiveListActivity.this, "Json Data is downloading", Toast.LENGTH_LONG).show();
        }

        @Override
        protected Void doInBackground(Void... voids) {
            HTTPHandler httpHandler = new HTTPHandler();
            String url = "https://40kapi.evinwijninga.com/objectives";
            ...
            if (jsonStr != null) {
                ...
                try {
                    ...
                    JSONArray scenarios = jsonObject.getJSONArray("objectives");
                    ...
                    for (int i = 0; i < scenarios.length(); i++) {
                        ...
                        if (s.getString("number") != null) {
                            id = s.getString("number");
                            Log.e(TAG, id);
                        } else {
                            Log.e(TAG, "id = null");
                        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            ListAdapter adapter = new SimpleAdapter(ObjectiveListActivity.this, scenarioList,
