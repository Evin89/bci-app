...
public class ObjectiveDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ObjectiveDetailActivity.getScenarioDetails().execute();
    }
    ...
    class getScenarioDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String url = "https://40kapi.evinwijninga.com/objectives/"+scenarioId;
            ...
            if (jsonStr != null) {
                ...
                try {
                    ...
                    for (int i = 0; i < scenario.length(); i++) {
                        ...
                        armies = s.getString("name");
                        battlefield = s.getString("description");
                    }
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            super.onPreExecute();
            Toast.makeText(ObjectiveDetailActivity.this, "Json Data is downloading", Toast.LENGTH_LONG).show();
        }
